---
title: "ADC Annex"
tagline: "ADC Annex — analog front-end testing"
image: "img/eboards/annex-boards/adc-annex.png"
group: "annex"
description: "ADC Annex for analog front-end evaluation, sampling and calibration."
draft: false
showHero: false
...
assets/images/bm833a-click.jpg
or
static/images/bm833a-click.jpg
-->
...
<img
src="/img/eboards/annex-boards/adc-annex.png"
alt="ADC Annex board"
...
<h1 class="text-4xl md:text-5xl font-light tracking-tight text-neutral-900 dark:text-neutral-100 mb-5">
ADC Annex
</h1>

<p class="text-lg leading-8 text-neutral-600 dark:text-neutral-300 mb-6">
The ADC Annex is a compact add-on board designed for precision analog-to-digital conversion. Powered by Microchip’s MCP3204 12-bit SAR ADC, it offers a 4-channel single-ended setup with a fast 100 ksps sampling rate and an SPI-compatible interface. Ideal for industrial monitoring, instrumentation, and remote data acquisition systems.
</p>

## Overview

The **ADC Annex** is a high-precision analog-to-digital converter expansion board powered by Microchip’s MCP3204 12-bit, 4-channel A/D converter with a fast SPI serial interface. Designed for reliable signal conversion in industrial, instrumentation, and data acquisition applications, it combines flexible reference selection, integrated signal conditioning, and dual-voltage MCU compatibility.

Key Features
12-Bit 4-Channel ADC: Driven by the Microchip MCP3204, supporting up to four single-ended input channels (CH0–CH3).

Onboard Signal Buffering: Every analog input passes through a Microchip MCP6284 5MHz rail-to-rail op-amp for optimal signal conditioning before conversion.

Flexible Reference Selection: Easily switch the reference voltage using the onboard REFERENCE jumper between VCC (3.3V/5V) or an ultra-stable 4.096V provided by the onboard Microchip MCP1541 voltage reference.

4-Wire SPI Communication: Supports standard SPI modes (0 and 3) at clock speeds up to 2 MHz, activated via a low CS line.

Dual Logic Voltage Support: Integrated PWR SEL jumper enables seamless operation with both 3.3V and 5V host microcontrollers.

Convenient Connectivity: Dedicated CH0–3 terminal blocks with twin GND connections simplify external analog sensor integration.
...
[Download Schematics (PDF)](/downloads/bm833a-click-schematic.pdf)

Contains the complete electrical schematic, including power, wireless module,
connectors, programming/debugging, status indicators, and supporting circuitry.

### Gerber Files

[Download Gerber Files (ZIP)](/downloads/bm833a-click-gerbers.zip)

Manufacturing package containing the PCB fabrication layers, solder mask,
silkscreen, copper, drill files, and board outline.

### Bill of Materials

[Download Bill of Materials (CSV)](/downloads/bm833a-click-bom.csv)

The BOM should include manufacturer part numbers, component values,
packages, quantities, approved alternatives, and sourcing information.

### 3D STEP Model

[Download 3D STEP Model](/downloads/bm833a-click.step)

STEP model for mechanical integration, enclosure design, clearance checks,
and CAD assembly work.

### Hardware Repository

[View Hardware Repository on GitHub](https://github.com/YOUR-USERNAME/bm833a-click-hardware)

The GitHub repository contains the latest schematic source files, PCB layout,
library files, manufacturing outputs, documentation, and revision history.
